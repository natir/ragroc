...
* @returns {boolean}
*/
export function set_gc_to() {
    var ret = wasm.set_gc_to();
    return ret !== 0;
}

/**
*/
export function finish_load() {
    wasm.finish_load();
}
...
* @returns {boolean}
*/
export function run_generate() {
    var ret = wasm.run_generate();
    return ret !== 0;
}
...
* @returns {boolean}
*/
export function run_revcomp() {
    var ret = wasm.run_revcomp();
    return ret !== 0;
}
...
async function init(input) {
    ...
    imports.wbg.__wbg_getElementsByName_ca8da378bd4a4a8a = function(arg0, arg1, arg2) {
        var ret = getObject(arg0).getElementsByName(getStringFromWasm0(arg1, arg2));
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbg_id_03f590c0f36b2c91 = function(arg0, arg1) {
